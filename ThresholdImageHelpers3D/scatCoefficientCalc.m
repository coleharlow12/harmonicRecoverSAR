...
%% Script
function [I] = scatCoefficientCalc(E,txLoc,rxLoc,lambda,scatLoc)
    tic
    ...
    NC = size(scatLoc,1); %number of cell points (NX*NY*NZ)
    ...
    I = I; %Scattering Coefficients do not have to be real numbers
end